...
<head>
  ...
  <style>
    ...
    :root {
      --bg-vanilla: #F9F6EE;
      --bg-silence: #F2EEE6;
      --color-sylvan-green: #557A61;
      --color-sylvan-dark: #355340;
      --color-sylvan-bg: #E4ECD3;
      --color-diaphonous: #437671;
      --color-diaphonous-bg: #E2F3F0;
      --color-marshmallow-bg: #EFEFF9;
      --color-butter-bg: #FFF4CD;
      --color-butter-text: #7A5E12;
      --color-barely-pink: #F4CCCC;
      --color-peach-apricot: #FCE5CD;
      --color-lavender-fog: #D7CADB;
    ...
    button:focus-visible, a:focus-visible, label:focus-visible, select:focus-visible {
      outline: 2px solid var(--color-sylvan-green);
      outline-offset: 2px;
    }
...
<body class="min-h-screen flex flex-col antialiased">
  ...
  <div id="dropZone" ondragover="handleDragOver(event)" ondragleave="handleDragLeave(event)" ondrop="handleDrop(event)" class="transition-all duration-200 border-2 border-dashed border-[#D5CCC0] bg-[#FFFDF9] max-w-7xl mx-auto w-full px-4 py-3 my-3 rounded-2xl text-center text-xs sm:text-sm text-[#7A726D] hidden sm:flex items-center justify-center gap-2.5 hover:border-[#557A61]">
  ...
  <main class="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
    ...
    <section id="tab-section-self" class="tab-content space-y-6">
      ...
      <div class="bg-[#FFFDF9] rounded-2xl p-4.5 border border-[#E8E2D8] soft-card-shadow flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div class="flex items-center gap-2 flex-wrap" id="self-supervisor-pills">
          <span class="text-xs font-bold text-[#8C837C] mr-1 flex items-center gap-1 uppercase tracking-wider">
            <i data-lucide="filter" class="w-3.5 h-3.5 text-[#557A61]"></i> 主管團隊：
          </span>
          <button onclick="filterSelfSupervisor('張希慈')" id="self-sup-btn-張希慈" class="self-sup-btn px-4 py-2.5 rounded-xl text-xs sm:text-sm font-semibold bg-[#557A61] text-white shadow-xs transition">
            張希慈 的部屬 (5人)
          </button>
          <button onclick="filterSelfSupervisor('何維安')" id="self-sup-btn-何維安" class="self-sup-btn px-4 py-2.5 rounded-xl text-xs sm:text-sm font-medium bg-[#F2EEE6] text-[#4A433E] hover:bg-[#EBE4D8] transition">
            何維安 的部屬 (1人)
          </button>
          <button onclick="filterSelfSupervisor('姚品瑄')" id="self-sup-btn-姚品瑄" class="self-sup-btn px-4 py-2.5 rounded-xl text-xs sm:text-sm font-medium bg-[#F2EEE6] text-[#4A433E] hover:bg-[#EBE4D8] transition">
            姚品瑄 的部屬 (2人)
          </button>
          <button onclick="filterSelfSupervisor('張希慈_執行長')" id="self-sup-btn-張希慈_執行長" class="self-sup-btn px-4 py-2.5 rounded-xl text-xs sm:text-sm font-medium bg-[#F2EEE6] text-[#4A433E] hover:bg-[#EBE4D8] transition">
            執行長個人自評
          </button>
          <button onclick="filterSelfSupervisor('ALL')" id="self-sup-btn-ALL" class="self-sup-btn px-4 py-2.5 rounded-xl text-xs sm:text-sm font-medium bg-[#F2EEE6] text-[#4A433E] hover:bg-[#EBE4D8] transition">
            全部已自評 (5人)
          </button>
        </div>
      ...
      <!-- RATING GUIDE CARD (L1 ~ L5 DEFINITION TABLE ACCORDING TO USER SPEC) -->
      <div class="bg-[#FFFDF9] rounded-2xl border border-[#E8E2D8] soft-card-shadow overflow-hidden">
        <div class="chunk-subheader-banner px-5 py-3 flex items-center justify-between cursor-pointer" onclick="toggleRatingGuide()">
          <div class="flex items-center gap-2.5">
            <i data-lucide="book-open" class="w-4 h-4 text-[#783E16]"></i>
            <h3 class="text-xs sm:text-sm font-bold text-[#4A2E1C] font-serif-tc">三、面向分數落點標準：Start / Grow / Keep / Good / Amazing!（評分參考）</h3>
          </div>
          <div class="flex items-center gap-1.5 text-xs text-[#7A4822]">
        ...
        <div id="rating-guide-content" class="p-5 overflow-x-auto">
          <table class="w-full text-xs sm:text-sm text-left border-collapse">
            <thead>
              <tr class="border-b border-[#E8E2D8] text-[#8C837C]">
                <th class="py-2.5 px-3 font-bold text-center w-16">Level</th>
                <th class="py-2.5 px-3 font-bold text-center w-24">落點名稱</th>
                <th class="py-2.5 px-3 font-bold text-center w-24">得分率</th>
                <th class="py-2.5 px-3 font-bold">定義說明</th>
                <th class="py-2.5 px-3 font-bold">回饋語氣與後續動作</th>
              </tr>
            </thead>
            <tbody class="divide-y divide-[#EFEAE1]">
              <tr class="bg-[#E4ECD3]/30">
                <td class="py-3 px-3 text-center font-bold text-[#2D5239]">L5</td>
                <td class="py-3 px-3 text-center font-bold text-[#2D5239]"><span class="badge-l5 px-2 py-0.5 rounded-md">Amazing!</span></td>
                <td class="py-3 px-3 text-center text-[#2D5239] font-medium">90% 以上</td>
                <td class="py-3 px-3 text-[#2E2827]">遠超職位期待，表現為團隊之標竿與典範。</td>
                <td class="py-3 px-3 text-[#4A433E]">讚賞其突出貢獻，探討經驗複製機制，在成長對話中轉為「可以帶其他人一起做」的方向。</td>
              </tr>
              <tr class="bg-[#E2F3F0]/30">
                <td class="py-3 px-3 text-center font-bold text-[#235954]">L4</td>
                <td class="py-3 px-3 text-center font-bold text-[#235954]"><span class="badge-l4 px-2 py-0.5 rounded-md">Good</span></td>
                <td class="py-3 px-3 text-center text-[#235954] font-medium">80% 以上</td>
                <td class="py-3 px-3 text-[#2E2827]">優於職位期待，持續展現高標準成果。</td>
                <td class="py-3 px-3 text-[#4A433E]">肯定並具體指出是哪些行為讓它超出標準，設定具挑戰性的下一步目標。</td>
              </tr>
              <tr class="bg-[#FFF4CD]/30">
                <td class="py-3 px-3 text-center font-bold text-[#7A5E12]">L3</td>
                <td class="py-3 px-3 text-center font-bold text-[#7A5E12]"><span class="badge-l3 px-2 py-0.5 rounded-md">Keep</span></td>
                <td class="py-3 px-3 text-center text-[#7A5E12] font-medium">60%–79%</td>
                <td class="py-3 px-3 text-[#2E2827]">符合職位門檻，展現穩定的工作交付。</td>
                <td class="py-3 px-3 text-[#4A433E]">確認穩定度，指出下一階可以再往前的地方，維持既有節奏並選一到兩項深化。</td>
              </tr>
              <tr class="bg-[#FCE5CD]/30">
                <td class="py-3 px-3 text-center font-bold text-[#8C4B1E]">L2</td>
                <td class="py-3 px-3 text-center font-bold text-[#8C4B1E]"><span class="badge-l2 px-2 py-0.5 rounded-md">Grow</span></td>
                <td class="py-3 px-3 text-center text-[#8C4B1E] font-medium">50%–59%</td>
                <td class="py-3 px-3 text-[#2E2827]">部分符合，部分能力/行為仍在建立階段。</td>
                <td class="py-3 px-3 text-[#4A433E]">說明落差在哪，聚焦一項具體可練習的行為，納入下一期 IDP 設定可觀察的行為指標。</td>
              </tr>
              <tr class="bg-[#F4CCCC]/30">
                <td class="py-3 px-3 text-center font-bold text-[#7A363A]">L1</td>
                <td class="py-3 px-3 text-center font-bold text-[#7A363A]"><span class="badge-l1 px-2 py-0.5 rounded-md">Start</span></td>
                <td class="py-3 px-3 text-center text-[#7A363A] font-medium">50% 以下</td>
                <td class="py-3 px-3 text-[#2E2827]">目前的具體事證還看不到這項職能，或事證與職能要求落差明顯。</td>
                <td class="py-3 px-3 text-[#4A433E]">明確對齊職位基本門檻與要求，提供即時支援與改進行動引導。</td>
              </tr>
            </tbody>
          </table>
          <p class="text-xs text-[#8C837C] mt-2.5 italic">註：本落點標準供主管評核與回饋時參照，不對員工直接公布分數與總分，只回饋落點方向與成長指標。</p>
        </div>
      </div>

      <!-- TEAM INFO BANNER -->
      <div id="self-team-banner" class="bg-[#FCE5CD]/40 border border-[#F3D1B0] rounded-2xl p-4.5 flex items-center justify-between">
        <div class="flex items-center gap-3">
          <div class="p-2.5 bg-[#F4CCCC] text-[#3E2426] rounded-xl shadow-2xs">
            <i data-lucide="users" class="w-5 h-5"></i>
          </div>
          <div>
            <h2 id="self-team-title" class="text-sm sm:text-base font-bold text-[#3E2426] font-serif-tc">張希慈 的部屬自評列表</h2>
            <p id="self-team-subtitle" class="text-xs sm:text-sm text-[#7A4822] mt-0.5">涵蓋部屬：何維安、陳泳璇、張芳媐、姚品瑄、胡喻翔</p>
          </div>
        </div>
        <div class="text-xs sm:text-sm px-3.5 py-1.5 bg-white/90 rounded-full text-[#783E16] font-bold border border-[#F3D1B0] shadow-2xs" id="self-completion-status">
          已填答 2 / 應填 5 人
        </div>
      </div>

      <!-- MEMBER SELF EVALUATION CARDS CONTAINER (CHUNK BY CHUNK) -->
      <div id="self-eval-cards-container" class="space-y-8">
    ...
    <section id="tab-section-supervisor" class="tab-content hidden space-y-6">
      <div class="bg-[#FFFDF9] rounded-2xl p-4.5 border border-[#E8E2D8] soft-card-shadow flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div class="flex items-center gap-2 flex-wrap">
          ...
          <button onclick="filterSupervisor('ALL')" id="sup-filter-btn-ALL" class="sup-filter-btn px-4 py-2.5 rounded-xl text-xs sm:text-sm font-semibold bg-[#557A61] text-white shadow-xs transition">
            全部主管 (4筆)
          </button>
          <button onclick="filterSupervisor('張希慈')" id="sup-filter-btn-張希慈" class="sup-filter-btn px-4 py-2.5 rounded-xl text-xs sm:text-sm font-medium bg-[#F2EEE6] text-[#4A433E] hover:bg-[#EBE4D8] transition">
            張希慈 (3筆)
          </button>
          <button onclick="filterSupervisor('何維安')" id="sup-filter-btn-何維安" class="sup-filter-btn px-4 py-2.5 rounded-xl text-xs sm:text-sm font-medium bg-[#F2EEE6] text-[#4A433E] hover:bg-[#EBE4D8] transition">
            何維安 (1筆)
          </button>
        </div>

        <button onclick="exportFullWorkbookClientSide()" class="inline-flex items-center gap-2 px-4 py-2.5 text-xs sm:text-sm font-semibold rounded-xl bg-[#F2EEE6] text-[#4A433E] hover:bg-[#EBE4D8] transition border border-[#E0D7CA]">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-[#FFFDF9] p-5.5 rounded-2xl border border-[#E8E2D8] soft-card-shadow">
          <h3 class="text-sm sm:text-base font-bold text-[#2E2827] mb-2 flex items-center gap-2 font-serif-tc">
        ...
        <div class="bg-[#FFFDF9] p-5.5 rounded-2xl border border-[#E8E2D8] soft-card-shadow lg:col-span-2">
          <h3 class="text-sm sm:text-base font-bold text-[#2E2827] mb-2 flex items-center gap-2 font-serif-tc">
      ...
      <div id="supervisor-feedback-list" class="space-y-4.5">
        <!-- Injected via JavaScript -->
      </div>
    </section>
    ...
    <section id="tab-section-peer" class="tab-content hidden space-y-6">
      ...
      <div id="peer-feedback-list" class="space-y-4.5">
        <!-- Injected via JavaScript -->
      </div>
    </section>
  ...
  <!-- TOAST NOTIFICATION -->
  <div id="toast" class="fixed bottom-6 right-6 z-50 transform transition-all duration-300 opacity-0 translate-y-4 pointer-events-none bg-[#2E2827] text-white px-4.5 py-3.5 rounded-2xl shadow-xl flex items-center gap-3 text-xs sm:text-sm border border-[#4A433E]">
  ...
  <footer class="bg-[#FFFDF9] border-t border-[#E8E2D8] py-6 text-center text-xs text-[#7A726D] mt-auto">
  ...
  <script>
    ...
    // Helper for generating Level Select Menu
    function getLevelSelectHtml(itemId, currentVal = '') {
      return `
        <div class="flex items-center gap-2 mt-2 pt-2 border-t border-[#E8E2D8]/60">
          <span class="text-xs font-bold text-[#8C837C] flex items-center gap-1">
            <i data-lucide="check-square" class="w-3.5 h-3.5 text-[#557A61]"></i> 主管評核等級：
          </span>
          <select class="lv-select text-xs font-medium px-3 py-1.5 rounded-lg border border-[#D5CCC0] bg-[#FFFDF9] text-[#2E2827] focus:border-[#557A61] focus:ring-1 focus:ring-[#557A61] transition" data-item-id="${itemId}" onchange="handleLevelChange(this)">
            <option value="" ${currentVal === '' ? 'selected' : ''}>-- 請選取 Level --</option>
            <option value="L5" ${currentVal === 'L5' ? 'selected' : ''}>L5 (Amazing! · 90%+ · 遠超期待/標竿)</option>
            <option value="L4" ${currentVal === 'L4' ? 'selected' : ''}>L4 (Good · 80%+ · 優於期待/高標)</option>
            <option value="L3" ${currentVal === 'L3' ? 'selected' : ''}>L3 (Keep · 60-79% · 符合期待/穩定)</option>
            <option value="L2" ${currentVal === 'L2' ? 'selected' : ''}>L2 (Grow · 50-59% · 部分符合/建立中)</option>
            <option value="L1" ${currentVal === 'L1' ? 'selected' : ''}>L1 (Start · <50% · 發展起步/落差)</option>
          </select>
          <span class="lv-badge-preview"></span>
        </div>
      `;
    }

    function handleLevelChange(selectElem) {
      const val = selectElem.value;
      const preview = selectElem.parentElement.querySelector('.lv-badge-preview');
      if (val === 'L5') {
        preview.innerHTML = `<span class="badge-l5 px-2 py-0.5 text-xs font-bold rounded-md">L5 · Amazing!</span>`;
      } else if (val === 'L4') {
        preview.innerHTML = `<span class="badge-l4 px-2 py-0.5 text-xs font-bold rounded-md">L4 · Good</span>`;
      } else if (val === 'L3') {
        preview.innerHTML = `<span class="badge-l3 px-2 py-0.5 text-xs font-bold rounded-md">L3 · Keep</span>`;
      } else if (val === 'L2') {
        preview.innerHTML = `<span class="badge-l2 px-2 py-0.5 text-xs font-bold rounded-md">L2 · Grow</span>`;
      } else if (val === 'L1') {
        preview.innerHTML = `<span class="badge-l1 px-2 py-0.5 text-xs font-bold rounded-md">L1 · Start</span>`;
      } else {
        preview.innerHTML = '';
      }
    }
    ...
    function renderSelfSection() {
      ...
      exportContainer.innerHTML = `
        <button onclick="exportSupervisorExcelClientSide('${currentSelfSupervisor}')" class="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl text-xs sm:text-sm font-semibold bg-[#557A61] text-white hover:bg-[#466551] transition shadow-xs">
          <i data-lucide="file-spreadsheet" class="w-4 h-4"></i>
          下載本組主管專用 XLSX 表格 (Chunk 格式＋選單)
        </button>
      `;
        ...
        if (entry && entry.self_eval) {
          ...
          html += `
            ...
            <div class="bg-[#FFFDF9] rounded-2xl border border-[#E8E2D8] soft-card-shadow overflow-hidden">
              ...
              <div class="chunk-header-banner px-6 py-4.5 flex flex-col md:flex-row md:items-center justify-between gap-3">
                <div class="flex items-center gap-3.5">
                  <div class="w-11 h-11 rounded-xl bg-[#3E2426] text-white font-bold flex items-center justify-center text-base font-serif-tc shadow-2xs">
                    ${memName.slice(0, 1)}
                  </div>
                  <div>
                    <div class="flex items-center gap-2.5">
                      <h3 class="text-base sm:text-lg font-bold text-[#3E2426] font-serif-tc">${memName}</h3>
                      <span class="px-2.5 py-0.5 text-xs font-semibold rounded-md bg-[#FFFDF9] text-[#4A2E1C] border border-[#EED1B4]">
                        ${se.job_role || '自評'}
                      </span>
                    ...
                    <p class="text-xs text-[#7A4822] mt-0.5">${entry.email} · 填答時間：${entry.timestamp}</p>
                  </div>
                </div>

                <div class="text-xs font-medium text-[#7A4822] bg-white/80 px-3.5 py-1.5 rounded-lg border border-[#E6BDBD]/60">
                  評分標準：L1(Start) ~ L5(Amazing!)
                </div>
              </div>
              ...
              <div class="p-6 sm:p-7 space-y-6">
                ...
                <!-- 2. 工作特質盤點 CHUNK -->
                <div>
                  <div class="text-xs font-bold text-[#8C837C] uppercase tracking-wider mb-3 flex items-center gap-1.5 font-serif-tc">
                    <i data-lucide="tag" class="w-3.5 h-3.5 text-[#557A61]"></i> 一、工作特質盤點
                  </div>
                  <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="bg-[#E4ECD3]/40 border border-[#CDE0BC] rounded-xl p-4.5">
                      <div class="text-xs font-bold text-[#2D5239] mb-2.5 flex items-center gap-1.5">
                    ...
                    <div class="bg-[#FCE5CD]/40 border border-[#F5D3B3] rounded-xl p-4.5">
                      <div class="text-xs font-bold text-[#8C4B1E] mb-2.5 flex items-center gap-1.5">
                ...
                <div>
                  <div class="text-xs font-bold text-[#8C837C] uppercase tracking-wider mb-3 flex items-center gap-1.5 font-serif-tc">
                    <i data-lucide="heart" class="w-3.5 h-3.5 text-[#557A61]"></i> 二、四大文化實踐實例 (STAR 敘述)
                  </div>
                  <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <!-- 信任 -->
                    <div class="bg-[#EFEFF9]/50 border border-[#D5D5EB] rounded-xl p-4.5 flex flex-col justify-between">
                      <div>
                        <div class="text-xs font-bold text-[#4B4770] mb-2 flex items-center gap-1.5">
                          <span class="w-2 h-2 rounded-full bg-[#7B7299]"></span> 信任 (Trust)
                        </div>
                        <p class="text-xs sm:text-sm text-[#2E2827] leading-relaxed">${se.values['信任'] || '（未填寫）'}</p>
                      </div>
                      ${getLevelSelectHtml(`cult-trust-${memName}`)}
                    </div>
                    <!-- 多元 -->
                    <div class="bg-[#E2F3F0]/50 border border-[#C4E6E1] rounded-xl p-4.5 flex flex-col justify-between">
                      <div>
                        <div class="text-xs font-bold text-[#2A5E59] mb-2 flex items-center gap-1.5">
                          <span class="w-2 h-2 rounded-full bg-[#437671]"></span> 多元 (Diversity)
                        </div>
                        <p class="text-xs sm:text-sm text-[#2E2827] leading-relaxed">${se.values['多元'] || '（未填寫）'}</p>
                      </div>
                      ${getLevelSelectHtml(`cult-diversity-${memName}`)}
                    </div>
                    <!-- 實驗 -->
                    <div class="bg-[#FFF4CD]/40 border border-[#FCE299] rounded-xl p-4.5 flex flex-col justify-between">
                      <div>
                        <div class="text-xs font-bold text-[#7A5E12] mb-2 flex items-center gap-1.5">
                          <span class="w-2 h-2 rounded-full bg-[#B88C22]"></span> 實驗 (Experiment)
                        </div>
                        <p class="text-xs sm:text-sm text-[#2E2827] leading-relaxed">${se.values['實驗'] || '（未填寫）'}</p>
                      </div>
                      ${getLevelSelectHtml(`cult-experiment-${memName}`)}
                    </div>
                    <!-- 可持續 -->
                    <div class="bg-[#E4ECD3]/50 border border-[#CDE0BC] rounded-xl p-4.5 flex flex-col justify-between">
                      <div>
                        <div class="text-xs font-bold text-[#2D5239] mb-2 flex items-center gap-1.5">
                          <span class="w-2 h-2 rounded-full bg-[#557A61]"></span> 可持續 (Sustainability)
                        </div>
                        <p class="text-xs sm:text-sm text-[#2E2827] leading-relaxed">${se.values['可持續'] || '（未填寫）'}</p>
                      </div>
                      ${getLevelSelectHtml(`cult-sustainability-${memName}`)}
                    </div>
                  </div>
                </div>
                ...
                ${se.competencies && se.competencies.length > 0 ? `
                  <div>
                    <div class="text-xs font-bold text-[#8C837C] uppercase tracking-wider mb-3 flex items-center gap-1.5 font-serif-tc">
                      <i data-lucide="briefcase" class="w-3.5 h-3.5 text-[#557A61]"></i> 三、${se.job_role} 專屬職能展現實例
                    </div>
                    <div class="space-y-3.5">
                      ${se.competencies.map((c, cIdx) => `
                        <div class="bg-[#FAF8F5] border border-[#E8E2D8] rounded-xl p-4.5">
                          <div class="text-xs sm:text-sm font-bold text-[#3E2723] mb-1.5 font-serif-tc">${c.title}</div>
                          <p class="text-xs sm:text-sm text-[#4A433E] leading-relaxed whitespace-pre-line">${c.answer || '（未填寫）'}</p>
                          ${getLevelSelectHtml(`comp-${memName}-${cIdx}`)}
                        </div>
                      `).join('')}
                    </div>
                  </div>
                ...
                ${se.reflection && Object.keys(se.reflection).length > 0 ? `
                  <div>
                    <div class="text-xs font-bold text-[#8C837C] uppercase tracking-wider mb-3 flex items-center gap-1.5 font-serif-tc">
                      <i data-lucide="help-circle" class="w-3.5 h-3.5 text-[#557A61]"></i> 四、組織卡關點反思與未來價值展望
                    </div>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ${Object.entries(se.reflection).map(([k, v], rIdx) => `
                        <div class="bg-[#FCE5CD]/30 border border-[#F3D1B0] rounded-xl p-4.5 flex flex-col justify-between">
                          <div>
                            <div class="text-xs sm:text-sm font-bold text-[#783E16] mb-1.5 font-serif-tc">${k}</div>
                            <p class="text-xs sm:text-sm text-[#4A433E] leading-relaxed">${v || '（未填寫）'}</p>
                          </div>
                          ${getLevelSelectHtml(`refl-${memName}-${rIdx}`)}
                        </div>
                      `).join('')}
                    </div>
                  </div>
          ...
          html += `
            <div class="bg-[#FFFDF9] rounded-2xl border border-[#E8E2D8] soft-card-shadow p-6 flex items-center justify-between">
              <div class="flex items-center gap-3.5">
                <div class="w-11 h-11 rounded-xl bg-[#F2EEE6] text-[#8C837C] font-bold flex items-center justify-center text-base font-serif-tc">
                  ${memName.slice(0, 1)}
                </div>
                <div>
                  <div class="flex items-center gap-2">
                    <h3 class="text-base font-bold text-[#2E2827] font-serif-tc">${memName}</h3>
                  ...
                  <p class="text-xs sm:text-sm text-[#8C837C] mt-0.5">此成員尚未於表單中送出自評紀錄，收到後上傳新 CSV 即可同步更新。</p>
                </div>
              </div>
              <div class="text-xs font-semibold text-[#8C837C] px-3 py-1 bg-[#F2EEE6] rounded-lg">待填寫</div>
            </div>
          `;
        }
      });
    ...
    function renderSupervisorSection() {
      ...
      feedbackContainer.innerHTML = filtered.map(e => {
        ...
        return `
          <div class="bg-[#FFFDF9] rounded-2xl border border-[#E8E2D8] p-5.5 soft-card-shadow space-y-4">
            <div class="flex items-center justify-between border-b border-[#E8E2D8] pb-3">
              <div class="flex items-center gap-2">
                <span class="font-bold text-[#2E2827] text-sm sm:text-base font-serif-tc">受評主管：${e.target}</span>
                <span class="text-xs text-[#8C837C]">（填答者：${e.email}）</span>
              </div>
              <div class="flex items-center gap-3 text-xs sm:text-sm">
                <span class="px-3 py-1 rounded-lg bg-[#E4ECD3] text-[#2D5239] font-bold">NPS 推薦：${se.q18_nps_recommend || '-'} 分</span>
                <span class="px-3 py-1 rounded-lg bg-[#FCE5CD] text-[#8C4B1E] font-bold">滿意度：${se.q19_satisfaction || '-'} 分</span>
              </div>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs sm:text-sm">
              <div class="bg-[#F2EEE6]/60 p-4 rounded-xl">
                <span class="font-bold text-[#557A61]">Q20. 願景使命理解之引導：</span>
                <p class="mt-1.5 text-[#4A433E] leading-relaxed">${se.q20_vision_mission || '（無）'}</p>
              </div>
              <div class="bg-[#F2EEE6]/60 p-4 rounded-xl">
                <span class="font-bold text-[#8C4B1E]">Q21. 管理與文化精神建議：</span>
                <p class="mt-1.5 text-[#4A433E] leading-relaxed">${se.q21_improvement_advice || '（無）'}</p>
              </div>
              <div class="bg-[#F2EEE6]/60 p-4 rounded-xl">
                <span class="font-bold text-[#2E2827]">Q22. 其他補充評價：</span>
                <p class="mt-1.5 text-[#4A433E] leading-relaxed">${se.q22_other_comments || '（無）'}</p>
              </div>
              <div class="bg-[#F4CCCC]/40 p-4 rounded-xl border border-[#F4CCCC]">
                <span class="font-bold text-[#7A363A] flex items-center gap-1.5">
                  <i data-lucide="award" class="w-4 h-4"></i> Q23. 肯定與感謝的話（好好星光大賞）：
                </span>
                <p class="mt-1.5 text-[#592629] font-medium leading-relaxed">${se.q23_starlight_thanks || '（無）'}</p>
              </div>
            </div>
          </div>
        `;
    ...
    function initPeerPills() {
      ...
      let html = `
        ...
        <button onclick="filterPeer('ALL')" id="peer-btn-ALL" class="peer-pill-btn px-3.5 py-2 rounded-xl text-xs sm:text-sm font-semibold bg-[#557A61] text-white shadow-xs transition">
      ...
      peers.forEach(p => {
        ...
        html += `
          <button onclick="filterPeer('${p}')" id="peer-btn-${p}" class="peer-pill-btn px-3.5 py-2 rounded-xl text-xs sm:text-sm font-medium bg-[#F2EEE6] text-[#4A433E] hover:bg-[#EBE4D8] transition">
            ${p} (${count})
          </button>
        `;
      });
      ...
      feedbackContainer.innerHTML = filtered.map(e => {
        ...
        return `
          <div class="bg-[#FFFDF9] rounded-2xl border border-[#E8E2D8] p-5.5 soft-card-shadow space-y-4">
            <div class="flex items-center justify-between border-b border-[#E8E2D8] pb-3">
              <div class="flex items-center gap-2">
                <span class="font-bold text-[#2E2827] text-sm sm:text-base font-serif-tc">受評同事：${e.target}</span>
                <span class="text-xs text-[#8C837C]">（填答者：${e.email}）</span>
              </div>
              <div class="flex items-center gap-3 text-xs sm:text-sm">
                <span class="px-3 py-1 rounded-lg bg-[#E4ECD3] text-[#2D5239] font-bold">NPS 推薦：${pe.q36_nps_recommend || '-'} 分</span>
                <span class="px-3 py-1 rounded-lg bg-[#F2EEE6] text-[#4A433E] font-medium">合作評分：${pe.q24_cooperation || '-'} 分</span>
              </div>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs sm:text-sm">
              <div class="bg-[#F2EEE6]/60 p-4 rounded-xl">
                <span class="font-bold text-[#2E2827]">Q37. 工作與文化提升建議：</span>
                <p class="mt-1.5 text-[#4A433E] leading-relaxed">${pe.q37_improvement_advice || '（無）'}</p>
              </div>
              <div class="bg-[#F2EEE6]/60 p-4 rounded-xl">
                <span class="font-bold text-[#2E2827]">Q38. 其他補充評價：</span>
                <p class="mt-1.5 text-[#4A433E] leading-relaxed">${pe.q38_other_comments || '（無）'}</p>
              </div>
              <div class="bg-[#F4CCCC]/40 p-4 rounded-xl border border-[#F4CCCC]">
                <span class="font-bold text-[#7A363A] flex items-center gap-1.5">
                  <i data-lucide="award" class="w-4 h-4"></i> Q39. 肯定與感謝的話（好好星光大賞）：
                </span>
                <p class="mt-1.5 text-[#592629] font-medium leading-relaxed">${pe.q39_starlight_thanks || '（無）'}</p>
              </div>
            </div>
          </div>
        `;
    ...
    function renderOverviewSection() {
      ...
      container.innerHTML = `
        <div class="bg-[#FFFDF9] rounded-2xl border border-[#E8E2D8] p-6 sm:p-7 soft-card-shadow space-y-6">
          <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-[#E8E2D8] pb-5">
            <div class="flex items-center gap-3.5">
              <div class="w-12 h-12 rounded-2xl bg-[#557A61] text-white font-bold flex items-center justify-center text-lg font-serif-tc shadow-xs">
                ${name.slice(0, 1)}
              </div>
              <div>
                <div class="flex items-center gap-2">
                  <h2 class="text-xl font-bold text-[#2E2827] font-serif-tc">${name} 360 綜合評估報告</h2>
                  ${se ? `<span class="px-2.5 py-0.5 text-xs font-semibold rounded-md bg-[#FCE5CD] text-[#783E16] border border-[#F3D1B0]">${se.job_role}</span>` : ''}
                </div>
            ...
            <div class="flex items-center gap-2 text-xs sm:text-sm flex-wrap">
              <span class="px-3.5 py-1.5 rounded-xl bg-[#E4ECD3] text-[#2D5239] font-bold">同事 NPS：${peerAvg('q36_nps_recommend')} 分</span>
              ${supEntries.length ? `<span class="px-3.5 py-1.5 rounded-xl bg-[#FCE5CD] text-[#8C4B1E] font-bold">主管 NPS：${supAvg('q18_nps_recommend')} 分</span>` : ''}
            </div>
          </div>
          ...
          ${se ? `
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div class="bg-[#E4ECD3]/40 border border-[#CDE0BC] rounded-xl p-4.5">
                ...
                <div class="flex flex-wrap gap-2">
                  ${se.top3_stable.map(t => `<span class="badge-stable px-3 py-1 text-xs font-semibold rounded-lg">${t}</span>`).join('')}
                </div>
              </div>
              <div class="bg-[#FCE5CD]/40 border border-[#F5D3B3] rounded-xl p-4.5">
                <div class="text-xs font-bold text-[#8C4B1E] mb-2.5 flex items-center gap-1.5">
                ...
                <div class="flex flex-wrap gap-2">
                  ${se.top3_practice.map(t => `<span class="badge-practice px-3 py-1 text-xs font-semibold rounded-lg">${t}</span>`).join('')}
                </div>
              </div>
            </div>
          ` : `
            <div class="bg-[#FFF4CD]/40 border border-[#FCE299] rounded-xl p-4.5 text-xs sm:text-sm text-[#7A5E12]">
          ...
          <!-- Starlight感謝詞 -->
          <div>
            <h3 class="text-sm sm:text-base font-bold text-[#7A363A] mb-3 flex items-center gap-2 font-serif-tc">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-3.5">
              ${[...supEntries, ...peerEntries].filter(e => (e.supervisor_eval?.q23_starlight_thanks || e.peer_eval?.q39_starlight_thanks)).map(e => {
                ...
                return `
                  <div class="bg-[#F4CCCC]/30 border border-[#F4CCCC] rounded-xl p-4 text-xs sm:text-sm text-[#592629] font-medium flex items-start gap-3">
                    <i data-lucide="heart" class="w-4 h-4 text-[#D48B7B] shrink-0 mt-0.5"></i>
                    <div>
                      <p class="leading-relaxed">"${text}"</p>
                      <span class="text-xs text-[#8C5558] mt-1.5 block">— 來自 ${e.relation} (${e.email.split('@')[0]})</span>
                    </div>
                  </div>
                `;
    ...
    // ==========================================
    // CLIENT-SIDE XLSX CHUNK EXPORT (WITH RATING GUIDE DEFINITIONS)
    // ==========================================
    function exportSupervisorExcelClientSide(supName) {
      ...
      rows.push([`評分標準與面向分數落點說明（不對員工公布分數與總分，只回饋落點）`]);
      rows.push(["等級 (Level)", "落點名稱", "得分率", "定義說明", "回饋語氣與後續動作"]);
      rows.push(["L5", "Amazing!", "90% 以上", "遠超職位期待，表現為團隊之標竿與典範。", "讚賞其突出貢獻，探討經驗複製機制，在成長對話中轉為「可以帶其他人一起做」的方向。"]);
      rows.push(["L4", "Good", "80% 以上", "優於職位期待，持續展現高標準成果。", "肯定並具體指出是哪些行為讓它超出標準，設定具挑戰性的下一步目標。"]);
      rows.push(["L3", "Keep", "60%–79%", "符合職位門檻，展現穩定的工作交付。", "確認穩定度，指出下一階可以再往前的地方，維持既有節奏並選一到兩項深化。"]);
      rows.push(["L2", "Grow", "50%–59%", "部分符合，部分能力/行為仍在建立階段。", "說明落差在哪，聚焦一項具體可練習的行為，納入下一期 IDP 設定可觀察的行為指標。"]);
      rows.push(["L1", "Start", "50% 以下", "目前的具體事證還看不到這項職能，或事證與職能要求落差明顯。", "明確對齊職位基本門檻與要求，提供即時支援與改進行動引導。"]);
      rows.push([]);
      ...
      memberNames.forEach(memName => {
        ...
        rows.push(["評估面向", "四大文化定義與說明", "部屬自評實例 (STAR)", "評分 (Lv.1-5選單)", "主管回饋 (Feedback)"]);
        ...
        // 組織卡關點
        if (se.reflection && Object.keys(se.reflection).length > 0) {
          const reflBannerR = rows.length;
          rows.push(["組織卡關點反思與未來價值展望", "", "", "", ""]);
          merges.push({ s: { r: reflBannerR, c: 0 }, e: { r: reflBannerR, c: 4 } });

          rows.push(["評估面向", "反思與展望項目", "部屬自評回覆內容", "評分 (Lv.1-5選單)", "主管回饋與備註"]);
          const reflStartR = rows.length;
          const reflEntries = Object.entries(se.reflection);
          reflEntries.forEach(([k, v]) => {
            rows.push(["卡關與展望", k, v || "（無填寫）", "", ""]);
          });
          merges.push({ s: { r: reflStartR, c: 0 }, e: { r: reflStartR + reflEntries.length - 1, c: 0 } });
        }
      ...
      showToast(`已成功下載【${supName}】部屬自評 XLSX（Chunk 格式＋落點說明）！`);
    }
...
print("Updated index.html with interactive Lv select menus and full Rating Guide card!")
