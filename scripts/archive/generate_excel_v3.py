...
# Removed "得分率" column as requested
RATING_GUIDE_ROWS = [
...
def create_supervisor_chunk_sheet(ws, supervisor_name, member_names, all_entries):
    ...
    # 3. Rating Guide Table Headers (No 得分率 column; Cols C:D merged for definition)
...
print("Saved all XLSX files without 得分率 column and with clean cross-column merging!")
