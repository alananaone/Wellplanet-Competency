...
<body class="min-h-screen flex flex-col antialiased">
  ...
  <script>
            ...
            <div class="bg-[#FFFDF9] rounded-2xl border border-[#E8E2D8] soft-card-shadow overflow-hidden">
              ...
              <div class="p-6 sm:p-7 space-y-6">
                ...
                <div>
                  ...
                  <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <!-- 信任 -->
                    <div class="bg-[#EFEFF9]/50 border border-[#D5D5EB] rounded-xl p-4.5">
                    ...
                    <!-- 多元 -->
                    <div class="bg-[#E2F3F0]/50 border border-[#C4E6E1] rounded-xl p-4.5">
                    ...
                    <!-- 實驗 -->
                    <div class="bg-[#FFF4CD]/40 border border-[#FCE299] rounded-xl p-4.5">
                    ...
                    <!-- 可持續 -->
                    <div class="bg-[#E4ECD3]/50 border border-[#CDE0BC] rounded-xl p-4.5">
                  ...
                  <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ${Object.entries(se.reflection).map(([k, v]) => `
                        <div class="bg-[#FCE5CD]/30 border border-[#F3D1B0] rounded-xl p-4.5">
    ...
    // ==========================================
    // CLIENT-SIDE XLSX CHUNK EXPORT (ZERO EMOJI + CLEAN MERGES)
    // ==========================================
    function exportSupervisorExcelClientSide(supName) {
      ...
      rows.push([`評分標準說明：Lv.1 ~ Lv.5（符合期待 ～ 超越期待） ｜ 填寫方式：主管可於每題右側欄位直接填寫等級評分與 Feedback 回饋`]);
      rows.push([]);
      ...
      memberNames.forEach(memName => {
        ...
        rows.push(["評估面向", "四大文化定義與說明", "部屬自評實例 (STAR)", "評分 (Lv.1-5)", "主管回饋 (Feedback)"]);
        ...
        if (se.competencies && se.competencies.length > 0) {
          ...
          rows.push(["評估面向", "職能項目與題目定義", "部屬自評實例", "評分 (Lv.1-5)", "主管回饋 (Feedback)"]);
        ...
        if (se.reflection && Object.keys(se.reflection).length > 0) {
          ...
          rows.push(["評估面向", "反思與展望項目", "部屬自評回覆內容", "評分 (Lv.1-5)", "主管回饋與備註"]);
      ...
      ws['!merges'] = merges;
      ws['!cols'] = [{ wch: 16 }, { wch: 36 }, { wch: 68 }, { wch: 14 }, { wch: 32 }];
...
print("Saved clean index.html with NO emoji and optimized typography scaling!")
